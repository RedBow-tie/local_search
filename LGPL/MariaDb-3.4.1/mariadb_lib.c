...
/*
* 2024-09-18  added dllexport for _mariadb_set_conf_option
* /
...
__declspec(dllexport)  my_bool _mariadb_set_conf_option(MYSQL *mysql, const char *config_option, const char *config_value)
{
  if (config_option)
  {
    int i;
